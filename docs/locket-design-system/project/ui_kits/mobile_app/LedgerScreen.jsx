    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: '4px 0' }}>
        {cells.map((day, i) => {
          ...
          let border = 'none';
          if (isPeriod)      { bg = T.menstrual; color = '#FFF'; }
          else if (isFuture) { bg = th.watermark; color = th.graphite; }
          else if (isToday)  { border = `2px solid ${T.locketBlue}`; color = T.locketBlue; }
